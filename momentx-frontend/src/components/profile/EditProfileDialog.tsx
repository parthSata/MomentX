...
export function EditProfileDialog({ isOpen, onClose, user, onSave }: EditProfileDialogProps) {
  ...
  const handleSave = async () => {
    ...
    onSave({ displayName, username, bio, website });
      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed z-50 left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[calc(100%-16px)] sm:w-[calc(100%-32px)] max-w-[500px] md:max-w-[600px] lg:max-w-[700px] xl:max-w-[800px] max-h-[calc(100vh-32px)] sm:max-h-[calc(100vh-64px)]"
          >
              ...
              <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-8 space-y-6 md:space-y-8">
                ...
                <div className="flex justify-center">
                  <div className="relative group">
                    <div className="w-24 h-24 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-36 lg:h-36 rounded-full bg-gradient-to-r from-neon-indigo via-neon-violet to-neon-pink p-1">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6">
                  ...
                  <div className="space-y-2 lg:col-span-2">
                    ...
                    <Textarea
                      ...
                      className="min-h-[100px] md:min-h-[120px] glass-strong border-border/50 focus:border-primary/50 resize-none text-base"
                      maxLength={150}
                    />
                    <p className="text-xs text-muted-foreground text-right">
                      {bio.length}/150

...
export function FeedPostOptionsDialog({ isOpen, onClose, postId, isOwnPost, onDelete }: FeedPostOptionsDialogProps) {
    ...
    // ✅ Conditionally render options based on ownership
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-50 w-[90%] max-w-sm glass-strong rounded-2xl overflow-hidden shadow-glow"
                    >
